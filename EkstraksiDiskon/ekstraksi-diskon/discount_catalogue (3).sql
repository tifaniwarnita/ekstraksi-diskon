...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2016 at 09:24 AM
...
INSERT INTO `wisata` (`id`, `category_id`, `username`, `screen_name`, `avatar`, `text`, `discount`, `price`, `image`, `created_at`, `tanggal`, `pembayaran`, `kode_voucher`) VALUES
...
--
ALTER TABLE `wisata`
ADD CONSTRAINT `fk_kategori_wisata2` FOREIGN KEY (`category_id`) REFERENCES `kategori` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
